...
test25 <- fft_1d(grid_info, nu2 = nu2, nu1 = nu_vals[1], a1 = a1, a2 = a2, Sigma_re = re_z, Sigma_im = im_z)[,2]
test15 <- fft_1d(grid_info, nu2 = nu2, nu1 = nu_vals[2], a1 = a1, a2 = a2, Sigma_re = re_z, Sigma_im = im_z)[,2]
test250 <- fft_1d(grid_info, nu2 = nu2, nu1 = nu_vals[3], a1 = a1, a2 = a2, Sigma_re = re_z, Sigma_im = im_z)[,2]
test8 <- fft_1d(grid_info, nu2 = nu2, nu1 = nu_vals[4], a1 = a1, a2 = a2, Sigma_re = re_z, Sigma_im = im_z)[,2]
...
## opposite
test25_opp <- fft_1d(grid_info, nu1 = nu2, nu2 = nu_vals[1], a2 = a1, a1 = a2, Sigma_re = re_z, Sigma_im = -im_z)[,2]
test15_opp <- fft_1d(grid_info, nu1 = nu2, nu2 = nu_vals[2], a2 = a1, a1 = a2, Sigma_re = re_z, Sigma_im = -im_z)[,2]
test250_opp <- fft_1d(grid_info, nu1 = nu2, nu2 = nu_vals[3], a2 = a1, a1 = a2, Sigma_re = re_z, Sigma_im = -im_z)[,2]
test8_opp <- fft_1d(grid_info, nu1 = nu2, nu2 = nu_vals[4], a2 = a1, a1 = a2, Sigma_re = re_z, Sigma_im = -im_z)[,2]
