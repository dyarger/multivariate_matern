...
df_1d <- fft_1d(nu1 = .5, nu2 = .5, a1 = 1, a2 = 1, Sigma_re = 0, Sigma_im = 1, grid_info = grid_info_1d)
...
df_2d <- fft_2d(nu1 = .5, nu2 = .5, a1 = 1, a2 = 1, d = 2, Psi = sign, 
                Mu =  function(x) complex(real = 0, imaginary = sign(x)), 
...
df_1d <- fft_1d(nu1 = 1.5, nu2 = .5, a1 = 1, a2 = 1, Sigma_re = 0, Sigma_im = 1, grid_info = grid_info_1d)
...
df_1d <- fft_1d(nu1 = .5, nu2 = .5, a1 = 1.2, a2 = 1, Sigma_re = 0, Sigma_im = 1, grid_info = grid_info_1d)
...
df_1d <- fft_1d(nu1 = .5, nu2 = .5, a1 = 1, a2 = 1, Sigma_re = 1, Sigma_im = 0, grid_info = grid_info_1d)
df_2d <- fft_2d(nu1 = .5, nu2 = .5, a1 = 1, a2 = 1, d = 2, Psi = sign, 
                Mu =  function(x) 1, grid_info = grid_info_2d)
plot(df_1d[abs(df_1d[,1]) < 10,], type = 'l')
lines(df_2d$Var2[df_2d$Var1 == min_abs_val], df_2d$val[df_2d$Var1 == min_abs_val], col = 2)

# compare real directional measure - mismatched nu
df_1d <- fft_1d(nu1 = 1.5, nu2 = .5, a1 = 1, a2 = 1, Sigma_re = 1, Sigma_im = 0, grid_info = grid_info_1d)
df_2d <- fft_2d(nu1 = 1.5, nu2 = .5, a1 = 1, a2 = 1, d = 2, Psi = sign, 
                Mu =  function(x) 1, grid_info = grid_info_2d)
plot(df_1d[abs(df_1d[,1]) < 10,], type = 'l')
lines(df_2d$Var2[df_2d$Var1 == min_abs_val], df_2d$val[df_2d$Var1 == min_abs_val], col = 2)
